...
if (pkg.version !== '2.5.2') fail(`package version is ${pkg.version}, expected 2.5.2 for upgraded security baseline`);
if (!app.includes("version: '2.5.2'")) fail('API root version marker is stale');
...
console.log('SANDMAN V2.4.1 security baseline audit passed on V2.5.2.');
