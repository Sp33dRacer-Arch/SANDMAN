...
if (pkg.version !== '2.6.1') fail(`package version is ${pkg.version}, expected 2.6.1 for upgraded security baseline`);
if (!app.includes("version: '2.6.1'")) fail('API root version marker is stale');
...
console.log('SANDMAN V2.4.1 security baseline audit passed on V2.6.1.');
